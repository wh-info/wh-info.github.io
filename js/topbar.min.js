...
const triggers = document.querySelectorAll(
  "#brightRepawn, #brightSpawn, #brightLeadsTo, #brightindMassB, #brightindMass, #brightToMassB, #brightToMass, #brightlifeTimeB, #brightlifeTime, #brightSigLevelB, #brightSigLevel"
  );
